/**
 * Empty data object factory for container schema.
 *
 * The presence tracker example only uses presence features, so no real
 * data object is required. However, the container schema requires at least
 * one initial object, so we provide an empty placeholder.
 */
...
/**
 * Simple FluidObject placeholder.
 */
...
/**
 * EmptyDO Factory - Export SharedObjectKind for registration.
 */
