...
Cache management commands for build artifacts and file hashes.

* [`sail cache clean`](#sail-cache-clean)
* [`sail cache info`](#sail-cache-info)
* [`sail cache prune`](#sail-cache-prune)
* [`sail cache stats`](#sail-cache-stats)
* [`sail cache verify`](#sail-cache-verify)
