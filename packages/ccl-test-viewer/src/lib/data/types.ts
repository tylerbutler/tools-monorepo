...
export const AVAILABLE_BEHAVIORS: CCLBehavior[] = ["tabs_preserve", "list_coercion_enabled", "crlf_preserve_literal", "crlf_normalize_to_lf", "strict_spacing", "list_coercion_disabled", "boolean_strict", "boolean_lenient"];
