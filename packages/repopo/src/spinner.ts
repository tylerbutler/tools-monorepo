/**
 * Code in this file is inspired by https://github.com/enormora/packtory
 */
import type { Spinner } from "@topcli/spinner";

type Status = "failure" | "success";

export type SpinnerManager = {
...
export type SpinnerManagerDependencies = {
...
export function createSpinnerManager(
	dependencies: SpinnerManagerDependencies,
): SpinnerManager {
