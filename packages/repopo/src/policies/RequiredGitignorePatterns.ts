...
import type { PolicyDefinition, PolicyFailure, PolicyFixResult } from "../policy.js";
...
function handleExistingGitignore(
	...
	if (resolve) {
		...
		try {
			const newContent = addPatternsToContent(gitignoreContent, missingPatterns);
 ...
 * @alpha
 */
export const RequiredGitignorePatterns: PolicyDefinition<RequiredGitignorePatternsSettings> = makePolicyDefinition(
