...
import { AllPackagesSelectionCriteria, EmptySelectionCriteria, filterPackages, selectAndFilterPackages, } from "../filter.js";
...
async function getMainWorkspacePackages() {
    ...
    const packages = fluidRepo.workspaces.get("main")?.packages;
...
describe("selectAndFilterPackages", () => {
    ...
    it("select directory", async () => {
        ...
        const { selected, filtered } = await selectAndFilterPackages(fluidRepo, selectionOptions, filters);
    ...
    it("selects all release groups", async () => {
        ...
        const { filtered } = await selectAndFilterPackages(fluidRepo, selectionOptions, EmptyFilter);
