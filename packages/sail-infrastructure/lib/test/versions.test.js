...
const main = repo.releaseGroups.get("main");
assert(main !== undefined);
const group2 = repo.releaseGroups.get("group2");
assert(group2 !== undefined);
const group3 = repo.releaseGroups.get("group3");
assert(group3 !== undefined);
const secondWorkspace = repo.workspaces.get("second");
