...
export class PackageManager {
     ...
     */
    getInstallCommandWithArgs(updateLockfile) {
        const resolvedCommand = resolveCommand(this.installName, updateLockfile ? "install" : "frozen", []);
