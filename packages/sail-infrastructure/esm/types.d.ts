 ...
 */
export type PackageJson = SetRequired<Pick<StandardPackageJson, "name" | "scripts" | "version" | "dependencies" | "devDependencies" | "peerDependencies" | "private" | "type">, "name" | "scripts" | "version"> & PnpmPackageJsonFields;
/**
 ...
 */
export declare function isIReleaseGroup(toCheck: Exclude<any, string | number | ReleaseGroupName | PackageName>): toCheck is IReleaseGroup;
/**
 ...
 */
export declare function isIPackage(pkg: any): pkg is IPackage;
